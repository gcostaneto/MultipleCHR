# adjustment of the MultiTrait function from BGLR.
# can put a priori relationship for traits (covT)
...
setResCov<-function(resCov,traits,error,Sy,R2,saveAt)
{
 ...
 # print(resCov$R)
  resCov$R <-  resCov$R+diag(1e-5,ncol=ncol(resCov$R),nrow=nrow(resCov$R))
                     ...
                     saveAt="",verbose=TRUE)
{
  ...
  Sy<-covT#cov(y,use="complete.obs")
